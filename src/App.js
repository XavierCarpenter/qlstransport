  ...
  render() {
    return <div className="App">
        ...
        {this.state.learn === false ? <div className="box about2" id="changeHeader">
            <div className="sub-box">
              <p className="subtext2">
                QLS Transport gives you the freedom to succeed on your own
                terms without any blood, sweat or tears. Explore our
                interactive diagram to find out more.
              </p>
            </div>
        ...
        <div className="box contact" id="contact">
          <div className="title-box">
            <h1 className="big-text contact" id="cTitle">CONTACT</h1>
          </div>
